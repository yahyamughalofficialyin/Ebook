...
<!-- Mirrored from bookland.dexignzone.com/xhtml/shop-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Dec 2024 20:04:51 GMT -->
<head>
	<meta charset="utf-8">
						...
						<div class="col-lg-6 col-md-6 mb-4">
							<div class="login-area">
								<div class="tab-content">
									...
									<a class="btn btn-primary btnhover m-r5 button-lg radius-no" href="shop-registration.html">CREATE AN ACCOUNT</a>
								</div>
							</div>
						</div>
						<div class="col-lg-6 col-md-6 mb-4">
